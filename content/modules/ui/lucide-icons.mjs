/**
 * Lucide Icons Module
 * Inline SVG icons from https://lucide.dev/icons/ (ISC license)
 * Tree-shaken subset: 25 icons covering all 4 UI surfaces
 */

const ICONS = {
  scissors: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="6" r="3"/><path d="M8.12 8.12 12 12"/><path d="M20 4 8.12 15.88"/><circle cx="6" cy="18" r="3"/><path d="M14.83 14.83 20 20"/></svg>',
  ...
  'key-round': '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 18v3c0 .6.4 1 1 1h3v-3h-2.5c-.3 0-.5-.2-.5-.5v-2c0-.3.2-.5.5-.5h2.5V14H4c-.6 0-1 .4-1 1v.5"/><path d="M2 6V3c0-.6.4-1 1-1h2.5v3H3c-.3 0-.5.2-.5.5v2c0 .3.2.5.5.5h2.5V6H3"/><path d="M11 6V3c0-.6-.4-1-1-1H7.5v3H9c.3 0 .5.2.5.5v2c0 .3-.2.5-.5.5H7.5V6h2.5"/><path d="M14 6V3c0-.6-.4-1-1-1h-1.5v3h.5c.3 0 .5.2.5.5v2c0 .3-.2.5-.5.5H11.5V6h1.5"/><circle cx="17" cy="15" r="4"/><path d="m17 13-2 2 2 2"/></svg>',
...
export function lucide(name, size = 16) {
  const wrapper = document.createElement('span');
  wrapper.className = `ns-icon ns-icon--${name}`;
...
export const LUCIDE_NAMES = Object.keys(ICONS);
export { ICONS };
